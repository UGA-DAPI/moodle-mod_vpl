...
class vpl_tokenizer_opl extends vpl_tokenizer_c{
    static $reserved_opl=null;
    function __construct(){
        parent::__construct();
        if(self::$reserved_opl === null){
            self::$reserved_opl = array('abstract' => true, 'continue' => true, 'for' => true, 'new' => true, 'switch' => true,
            ...
            $this->reserved=self::$reserved_opl;
        }
    }
}
