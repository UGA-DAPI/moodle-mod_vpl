...
$string ['basic'] = '基本';
$string ['calculate'] = '計算';
$string ['case_sensitive'] = '大文字と小文字を区別';
...
$string ['contextual_help'] = '項目ヘルプ';
$string ['copy'] = 'コピー';
$string ['copy_text'] = '選択したテキストをクリップボードにコピー';
$string ['create_new_file'] = '新規ファイルの作成';
$string ['currentstatus'] = '現在の状態';
$string ['cut'] = 'カット';
$string ['cut_text'] = '選択したテキストをクリップボードにカット';
...
$string ['diff'] = '差分';
$string ['direct_applet'] = 'アプレットの直接提供';
$string ['direct_applet_description'] = 'アプレットを提供するためにHTMLタグを使用する。クライアントがwww.java.comへアクセスできない場合に、このオプションを設定する';
...
$string ['find'] = '検索';
$string ['find_find_replace'] = '検索と置換';
$string ['find_next_search_string'] = 'テキストの次の検索文字列を見つける';
$string ['find_replace'] = '検索/置換';
$string ['font_size'] = 'フォントサイズ';
$string ['fulldescription'] = '詳細説明';
$string ['fullscreen'] = '全画面';
$string ['general_help'] = '言語に関する一般的なヘルプ';
$string ['go_next_page'] = '次のページへ進む';
...
$string ['proxy_port_from'] = 'プロキシーで利用できる最初のポート番号';
$string ['proxy_port_from_description'] = 'クライアントをjailに接続するのにプロキシーを利用しています。サーバのファイアウォールではこのポート範囲を許可しなければなりません';
$string ['proxy_port_to'] = 'プロキシーで利用できる最後のポート番号';
$string ['proxy_port_to_description'] = 'クライアントをjailに接続するのにプロキシーを利用しています。サーバのファイアウォールではこのポート範囲を許可しなければなりません';
$string ['redo'] = '再実行';
$string ['redo_undone'] = '直前の取り消しを再実行';
$string ['regularscreen'] = '通常画面';
$string ['removegrade'] = '採点の削除';
$string ['rename'] = '名前変更';
$string ['renameFile'] = 'ファイル名の変更';
$string ['replace'] = '置換';
$string ['replace_all'] = 'すべて置換';
$string ['replace_all_next'] = '次の検索文字列をすべて置換';
...
$string ['return_to_previous_page'] = '直前のページに戻る';
$string ['run'] = '実行';
$string ['running'] = '実行中';
$string ['save'] = '保存';
...
$string ['select_all_text'] = 'すべてのテキストを選択';
$string ['server'] = 'サーバ';
...
$string ['toggle_show_line_number'] = '行番号表示の切り替え';
$string ['totalnumberoferrors'] = 'エラー';
$string ['undo'] = '取り消し';
$string ['undo_change'] = '変更の取り消し';
$string ['unzipping'] = '展開中...';
$string ['uploadfile'] = 'ファイルのアップロード';
$string ['usevariations'] = 'バリエーションの利用';
$string ['variation'] = 'バリエーション{$a}';
